...
class Record(object):
    ...
    def __init__(self, xml_record):
        ...
        self.url = 'https://export.arxiv.org/abs/' + self.id#changed to export url
    ...
    def _get_text(self, namespace, tag,ids=False):
    ...
    def _get_authors(self):
        ...
        for author in authors_xml:
            try:
                first_names.append(author.find(ARXIV + 'forenames').text)
            except:
                first_names.append('$UNK')
...
class Scraper(object):
    ...
    def __init__(self, category, date_from=None, date_until=None, t=30, timeout=300, filters={}):
        ...
        if date_until is None:
            ...
            self.url = BASE + 'from=' + self.f + '&metadataPrefix=arXiv&set=%s' % self.cat
